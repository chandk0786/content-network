...
export default function Tool() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10">
      <Card>
        <CardHeader>
          <h1 className="text-2xl font-semibold">"Car Ownership Cost Calculator"</h1>
          <p className="text-sm text-gray-600 mt-2">"Estimate the annual cost of owning a car including fuel, insurance and maintenance."</p>
        </CardHeader>
