...
export default function Tool() {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-10">
      <Card>
        <CardHeader>
          <h1 className="text-2xl font-semibold">"Savings Goal Planner"</h1>
          <p className="text-sm text-gray-600 mt-2">"Plan monthly savings needed to hit your target amount."</p>
        </CardHeader>
